...
Print (or "\n") could be put after program output, so it's not created blank line before program output
Comments from the final versions of the program could be deleted, as they just double the code most cases and make it uncomfortable to read by humans.
